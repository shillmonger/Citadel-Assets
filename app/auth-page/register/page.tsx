        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="text-left">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-[var(--radix-dropdown-menu-trigger-width)] max-h-72 overflow-hidden flex flex-col p-0">
                ...
                <div className="sticky top-0 bg-white p-2 border-b border-gray-100 z-10">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-8 pr-3 py-2 text-sm border-none bg-gray-50 rounded-md focus:ring-1 focus:ring-[#1e40af] outline-none"
                      value={searchTerm}
                      onChange={(e) => setSearchTerm(e.target.value)}
                      onKeyDown={(e) => e.stopPropagation()} // Prevent dropdown from closing on spacebar
                    />
                  </div>
                </div>
                {/* List of Countries */}
          ...
          <div className="flex justify-center py-2">
            {hcaptchaLoaded && (
              <div
                className="h-captcha"
                data-sitekey={process.env.NEXT_PUBLIC_HCAPTCHA_SITE_KEY || "049c4e0e-82f8-4d60-acee-069406609eae"}
                data-test="false"
